...
>
> **Owner pivot (2026-09-24), a proposal:** [18](18-lean-start-broker-algo-plan.md) and [ADR-010](adr/ADR-010-lean-start-learn-practise-review.md). A lean, Hindi-first **Learn → Practise → Review** app built on Kotak/Zerodha. Backtesting and EOD paper trading can be offered now; live-price paper trading is blocked. Automation is gated (self-hosted first, empanelment later). This conflicts with CLAUDE.md's no-orders rule until ADR-010 is accepted.
>
> **Start here for "what can we actually build": [17](17-what-is-achievable.md).** About 20 of the 28 features are legal as information-only. Data licences, not technology, are the binding constraint. Cards can reach users in under 300 ms on a warm session.
...
| 17 | [What is practically achievable](17-what-is-achievable.md) | Both: every requested capability rated NOW / LICENCE / REG / NO, with data cost, SEBI posture, latency, effort, packages and a phased plan |
| 18 | [Lean start: broker APIs, backtest, paper, automation](18-lean-start-broker-algo-plan.md) | Owner: Kotak Neo / Zerodha, backtesting, paper trading, automated trading, One-Percent-style features, cheap 8-week build (proposal, ADR-010) |
| ADR | [001](adr/ADR-001-product-direction.md) · [002](adr/ADR-002-delayed-first-market-data.md) · [003](adr/ADR-003-modular-monolith-postgres.md) · [004](adr/ADR-004-llm-role-grounded-only.md) · [005](adr/ADR-005-retire-adk-and-nl-orchestrator.md) · [006](adr/ADR-006-quick-response-tier-and-runtime.md) · [007](adr/ADR-007-jev-as-optional-triage-classifier.md) · [008](adr/ADR-008-india-first-market-assistant-scope.md) · [009](adr/ADR-009-finance-model-layer.md) · [010](adr/ADR-010-lean-start-learn-practise-review.md) | Durable decisions (all *Proposed*) |
| Research | [market-data](research/market-data.md) · [products](research/products.md) · [infrastructure](research/infrastructure.md) · [papers](research/papers.md) · [low-latency](research/low-latency.md) · [fast-fetch](research/fast-fetch.md) · [decision-engines](research/decision-engines.md) · [reactive-and-jev](research/reactive-and-jev.md) · [india-market-data-and-sebi](research/india-market-data-and-sebi.md) · [global-news-and-data](research/global-news-and-data.md) · [assistant-300ms-and-jev](research/assistant-300ms-and-jev.md) · [distribution-and-competitors-india](research/distribution-and-competitors-india.md) · [accuracy-indicators-algos](research/accuracy-indicators-algos.md) · [finance-models-catalogue](research/finance-models-catalogue.md) · [finance-models-evidence](research/finance-models-evidence.md) · [kite-and-broker-apis](research/kite-and-broker-apis.md) · [papers-india](research/papers-india.md) · [case-studies](research/case-studies.md) · [official-sources-and-tools](research/official-sources-and-tools.md) · [data-stack-costs](research/data-stack-costs.md) · [feature-legality](research/feature-legality.md) · [build-cost-latency](research/build-cost-latency.md) · [algo-legal-path](research/algo-legal-path.md) · [broker-algo-apis](research/broker-algo-apis.md) · [one-percent-and-algo-comps](research/one-percent-and-algo-comps.md) · [fast-cheap-stack](research/fast-cheap-stack.md) · [tech-radar](research/tech-radar.md) | Raw evidence with sources |
